        ...
        <div id="sobre" className="px-4 py-5 my-5 text-center">
            ...
            <div className="col-lg-6 mx-auto">
                ...
                <div className="d-grid gap-2 d-sm-flex justify-content-sm-center">
                   <a href="https://treinamento.altu.com.br/widgets/preview/bd3de5d9a10bd2d07516f1fb717a8d65" target="_blank" rel="noreferrer">
                       <button type="button" className="btn btn-success btn-lg px-4 gap-3">Nosso Chat</button>
                    </a>
                    <Link to={"/login"}>
                        <button type="button" className="btn btn-outline-secondary btn-lg px-4">Acessar Plataforma</button>
                    </Link>
                </div>
            </div>
        </div>
